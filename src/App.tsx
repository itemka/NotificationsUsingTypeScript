...
class App extends Component<IObjectOfProps> {
    ...
    onClickButtonSuccess = () => {
        this.props.AddNotificationThunk(`Success`, `someText`, `Success`);
    };
    onClickButtonWarning = () => {
        this.props.AddNotificationThunk(`Warning`, `someText`, `Warning`);
    };
    onClickButtonError = () => {
        this.props.AddNotificationThunk(`Error`, `someText`, `Error`);
    };
